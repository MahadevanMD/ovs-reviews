 ...
 *
 * Sends NXT_GENEVE_TABLE_REQUEST and transition to
...
static void
recv_S_CLEAR_FLOWS(const struct ofp_header *oh OVS_UNUSED,
                   enum ofptype type OVS_UNUSED)
{
}

...
static void
recv_S_UPDATE_FLOWS(const struct ofp_header *oh OVS_UNUSED,
                    enum ofptype type OVS_UNUSED)
{
}

